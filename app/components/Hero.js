    ...
    <div>
      ...
      <div className='relative isolate overflow-hidden pt-14'>
        <img
          ...
          alt='A panned out view of video game character Link on top of the mountain as featured in Nintendo Switch title, The Legend of Zelda: Breath of the Wild.'
        ...
        <div className='mx-auto max-w-2xl py-16 sm:py-16 lg:pb-52'>
          <div className='text-center'>
            ...
            <p className='mt-6 text-lg leading-8 text-gray-100 drop-shadow-md'>
              Always unsure of what to play next? Game Log helps you determine
              your next gaming adventure by keeping you organized.
            </p>
